package com.haier.openplatform.hopdeploy.webapp.util;
...
public class CasUtil {
	...
	public static String getServerName(HttpServletRequest request) {
		...
		String serverName = request.getRequestURL().delete(
				request.getRequestURL().length() - request.getRequestURI().length(), request.getRequestURL().length()).toString();
